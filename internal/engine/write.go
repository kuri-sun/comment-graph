...
// WriteGraph renders the graph to comment-graph.yml (default) or a custom path.
// If outputPath is empty, it writes to root/comment-graph.yml. Relative paths are
